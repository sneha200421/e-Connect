...
public class CreatePost extends AppCompatActivity {
    ...
    private void uploaddata() {
        ...
        FirebaseDatabase.getInstance().getReference().child("posts").child(mycurrenttime2).setValue(u).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
        ...
        FirebaseDatabase.getInstance().getReference().child(FirebaseAuth.getInstance().getUid() + "posts").child(mycurrenttime2).setValue(u).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
