...
public class MyAdapter extends RecyclerView.Adapter<productviewholder> {
    ...
    public void onBindViewHolder(@NonNull productviewholder holder, int
        ...
        mDataBaseRef.child(holder.t4.getText().toString()+"likes").child("likes").addValueEventListener(new ValueEventListener() {
                    @Override
                ...
                if(null!=activenetwork){
                    FirebaseDatabase.getInstance().getReference().child(FirebaseAuth.getInstance().getUid()+"temporary").child("1").
                            setValue(u).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    Intent i = new Intent(pcontext,Send_Post.class);
        ...
        id = f1.getUid();
        forfriends u2 = new forfriends(holder.t1.getText().toString(), holder.prop,holder.t5.getText().toString());
            ...
            public void onClick(View view) {
                ...
                if(null!=activenetwork){
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .setValue(u2).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
