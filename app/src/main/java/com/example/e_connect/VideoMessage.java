...
//LinearLayoutManager gridLayoutManager = neLinearLayoutManager(getApplicationContext());
        ...
        refrence = FirebaseDatabase.getInstance().getReference("videomessage"+userId);
