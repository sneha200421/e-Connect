...
import com.example.e_connect.ChangePasswordActivity;
import com.example.e_connect.Friends;
import com.example.e_connect.MainActivity;
import com.example.e_connect.Message;
import com.example.e_connect.ProfileActivity;
import com.example.e_connect.R;
import com.example.e_connect.VideoMessage;
import com.example.e_connect.YourPost;
import com.example.e_connect.YourVideoPost;
import com.example.e_connect.userinfo;
...
public class fragment3 extends Fragment {
    ...
    Button btn,btn2,btn3,btn4,btn5,btn6,btn7,btncng;
    CircleImageView c1;
    TextView t1;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btncng = (Button)view.findViewById(R.id.button_change_pwd);
                            ...
                            alertDialog.setPositiveButton("Yes", new
                                    DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog,int
                                            ...
                                            Intent i5 = new Intent(getActivity(), MainActivity.class);
                                            startActivity(i5);
                                        }
                                    });
