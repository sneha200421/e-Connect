        ...
        holder.b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(null!=activenetwork){
                    FirebaseDatabase.getInstance().getReference().child(id3+"friends").child(holder.t2.getText().toString()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
