...
public class SendVideoPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycle=(RecyclerView) findViewById(R.id.lastrecycler);
        ...
        MyAdapter7 myadapter = new MyAdapter7(SendVideoPost.this, prolist3);
